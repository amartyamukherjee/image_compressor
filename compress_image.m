...
paddedP = pad15(P);
[padded_rows, padded_columns, padded_colours] = size(paddedP);
...
for colour = 1:3
    ...
    for r = 0:rows_of_15 - 1
        for c = 0:cols_of_15 - 1
            block = paddedP(15*r+1:15*(r+1), 15*c+1:15*(c+1), colour);
...
compression_rate = 100*num_zeros/(padded_rows*padded_columns*colours);
end
